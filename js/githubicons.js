(function(){
  ...
  gitFork.setAttribute('src', 'http://ghbtns.com/github-btn.html?user=callmenick&repo=d3-squiggly-line&type=fork&count=true');
  ...
  gitWatch.setAttribute('src', 'http://ghbtns.com/github-btn.html?user=callmenick&repo=d3-squiggly-line&type=watch&count=true');
